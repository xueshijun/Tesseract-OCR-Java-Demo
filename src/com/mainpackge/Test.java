...
//	 
		...
		ItemType[] itemType=jingDong.getItemType();
		System.out.print("["+itemType.length+"]:");
		for(int i=0;i<itemType.length;i++)
			System.out.print(itemType[i].TypeName+" | ");
//		 
		System.out.println();
		...
		ItemImg[] strItemImg=jingDong.getItemImg();
		System.out.println(strItemImg.length);
//		for(int i=0;i <strItemImg.length;i++) { 
//				System.out.println("\t小图:"+strItemImg[i].getSmallImgSrc());
//				System.out.println("\t大图:"+strItemImg[i].getBigImgSrc()); 
//		} 
